    ...
    $.ajax(
        {
            ...
            data:{"subjectName":subjectName,"optionA":optionA,"optionB":optionB,"optionC":optionC,
                "optionD":optionD,"rightResult":rightResult,"subjectEasy":subjectEasy,"division":division,
                "courseId":courseId,"gradeId":gradeId,"subjectScore":subjectScore},
    ...
    $.ajax(
        {
            ...
            type:"POST",
            data:{"subjectId":subjectId,"subjectName":subjectName,"subjectType":subjectType,"optionA":optionA,"optionB":optionB,
                "optionC":optionC,"optionD":optionD,"rightResult":rightResult,"subjectEasy":subjectEasy,
                "division":division,"courseId":courseId,"gradeId":gradeId,"subjectScore":subjectScore},
            success:function(data){
                layer.close(a);
                if(data.state==0){
                    layer.msg(data.msg,function () {
