...
<head>
    ...
    <link rel="stylesheet" type="text/css" href=" /js/zeroModal/zeroModal.css"/>
    <style type="text/css">
        .dropdown-toggle {
            height: 30px;
        }
...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-8 column">
            <form id="myform" class="form-horizontal" role="form" action="${path}/subject/uploadSubjectInfo.action" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
						...
						<b class="tips">题目</b>|<b class="tips">答案A-D</b>|<b class="tips">正确答案</b>|<b class="tips">分值</b>|<b
                                    class="tips">试题类型</b>|<b class="tips">难易程度</b>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input id="uploadSubmit" value="提交" type="submit" class="btn btn-default">
                    </div>
                </div>
            </form>
        </div>
...
<script src="/js/exam_subject.js"></script>
<script type="text/javascript">
    function uploadSubmit() {
        alert("******************");
        // $.ajax({
        //     type:'post',
        //     url:'/uploadSubjectinfo',
